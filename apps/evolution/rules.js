...
(function (전역) {
  ...
  var GENES = [
    /* 보이는 형질 9 */
    { k:'fur',   n:'털',          s:'F', d:'두꺼움', r:'얇음',   뜻:'몸을 덮은 털의 두께. 두꺼우면 열이 잘 빠져나가지 않지만, 더운 곳에서는 짐이 되고 물에 젖으면 무거워집니다.',
      과학:'두꺼운 털은 털 사이사이에 공기를 가둡니다. 공기는 열을 잘 전하지 않아서, 몸에서 빠져나가는 열을 붙잡아 둡니다 — 이것을 단열이라고 합니다. 얇은 털은 열을 그대로 내보내므로 몸이 빨리 식습니다.', 유리:'추운 곳 · 바람이 세게 부는 곳', 불리:'더운 곳 (쌓인 열을 버리지 못합니다) · 물속 (젖으면 공기층이 사라져 단열이 안 되고 무거워집니다)',
      보임:true },
    { k:'color', n:'색',          s:'D', d:'어두움', r:'밝음',   뜻:'몸 빛깔. 배경과 비슷하면 눈에 덜 띕니다. 어두운 몸은 그늘에, 밝은 몸은 눈밭과 마른 풀에 묻힙니다.',
      과학:'몸 빛깔은 배경과 얼마나 비슷한가로 정해집니다. 배경과 비슷하면 잡아먹는 쪽의 눈에 덜 띕니다 — 이것을 위장이라고 합니다. 어두운 색은 빛을 흡수하고 밝은 색은 되쏩니다.', 유리:'어두움 → 그늘진 곳 · 바위처럼 검은 곳 / 밝음 → 눈밭 · 마른 풀밭 · 볕이 강한 곳', 불리:'배경과 반대인 곳이면 어느 쪽이든 불리합니다. 어두운 몸은 뜨거운 볕 아래서 열까지 더 받습니다',
      보임:true },
    { k:'eye',   n:'눈',          s:'E', d:'큰 눈',  r:'작은 눈', 뜻:'눈의 크기. 크면 멀리까지, 어두운 곳까지 봅니다. 대신 강한 빛과 모래바람에 약합니다.',
      과학:'눈이 크면 빛을 받아들이는 면이 넓어져, 어두운 곳에서도 보이고 멀리까지 봅니다. 대신 크고 축축한 눈은 다치기 쉽고, 강한 빛에는 눈이 부십니다.', 유리:'어두운 곳 · 멀리까지 봐야 하는 트인 곳 · 천적이 있는 곳', 불리:'모래바람이 부는 곳 · 볕이 아주 강한 곳',
      보임:true },
    { k:'leg',   n:'다리',        s:'L', d:'많음',   r:'적음',   뜻:'다리 수. 많으면 빠르고 잘 넘어지지 않습니다. 대신 무른 땅과 물속에서는 걸리적거립니다.',
      과학:'다리가 많으면 몸무게가 여러 곳으로 나뉘고 딛는 점이 늘어서, 빨리 달리고 잘 넘어지지 않습니다. 대신 다리마다 힘을 써야 하고 물속에서는 물의 저항을 받습니다.', 유리:'달아나야 하는 트인 곳 · 발이 빠지는 무른 땅 · 발 디딜 곳이 좁은 바위', 불리:'모래처럼 아주 무른 곳 (많은 발이 오히려 자꾸 빠집니다) · 물속 (헤엄에 걸리적거립니다)',
      보임:true },
    { k:'tall',  n:'키',          s:'T', d:'큼',     r:'작음',   뜻:'몸집과 키. 크면 높은 곳에 닿고 멀리 봅니다. 대신 좁은 곳을 못 지나고 바람과 물살을 그대로 받습니다.',
      과학:'키가 크면 높은 곳에 닿고 멀리 봅니다. 대신 몸이 크면 겉넓이도 늘어 열을 빨리 잃거나 얻고, 바람과 물살을 받는 면도 넓어집니다. 좁은 틈은 지나가지 못합니다.', 유리:'먹이가 높이 달린 곳 · 풀 너머를 봐야 하는 곳', 불리:'바람이 낮게 깔리는 곳 · 나뭇가지가 촘촘한 곳 · 물살이 센 곳 · 땅이 흔들릴 때 (넘어집니다)',
      보임:true },
    { k:'water', n:'물저장 조직', s:'W', d:'있음',   r:'없음',   뜻:'몸 안에 물을 담아 두는 주머니. 있으면 마른 곳에서 버팁니다. 대신 무게가 늘어납니다. — 많다고 늘 좋은 것은 아닙니다.',
      과학:'몸 안에 물을 담아 두는 주머니입니다. 마른 곳에서 물 없이 버티게 해 주지만, 물은 무거워서 담은 만큼 몸이 굼떠집니다. 담는 양과 무게 사이에 주고받기가 있습니다.', 유리:'물을 오래 못 마시는 곳', 불리:'많이 담을수록 무거워집니다 — 있고 없고보다 «얼마나» 가 중요한 형질입니다',
      보임:true },
    { k:'grip',  n:'발톱',        s:'G', d:'강함',   r:'약함',   뜻:'발끝의 갈고리. 바위와 나뭇가지를 단단히 붙잡습니다.',
      과학:'발끝의 갈고리입니다. 표면의 오톨도톨한 곳에 걸려 마찰을 크게 만들어, 미끄러운 데서도 몸을 붙잡아 둡니다.', 유리:'깎아지른 바위 · 나뭇가지 · 땅이 흔들리는 때 · 세게 부딪히는 충격', 불리:'헤엄칠 때는 붙잡을 것이 없어 쓸모가 없습니다',
      보임:true },
    { k:'arm',   n:'팔',          s:'A', d:'있음',   r:'없음',   뜻:'뻗어서 붙잡는 팔. 매달리고 끌어당깁니다. 대신 밖으로 드러난 만큼 열을 잃습니다.',
      과학:'뻗어서 붙잡고 끌어당기는 팔입니다. 매달리고 열매를 따고 나무를 건너다닙니다. 대신 몸 밖으로 길게 나와 있어 표면이 넓고, 그만큼 열을 빨리 잃습니다.', 유리:'나무 위 · 붙잡고 옮겨 다녀야 하는 곳', 불리:'아주 추운 곳 (길게 뻗은 부분부터 얼어붙습니다)',
      보임:true },
    { k:'fin',   n:'지느러미',    s:'N', d:'있음',   r:'없음',   뜻:'물을 밀어내는 지느러미. 물에서만 쓸모가 있습니다.',
      과학:'물을 뒤로 밀어내 몸을 앞으로 보내는 넓적한 지느러미입니다. 물은 공기보다 훨씬 빽빽해서, 밀어낼 면이 없으면 앞으로 나아가지도 뜨지도 못합니다.', 유리:'물속 — 여기서는 거의 없으면 안 되는 형질입니다', 불리:'땅 위에서는 무게만 되고 걷는 데 방해가 됩니다',
      보임:true },
    /* 더듬이 — 감각기관.
    ...
    { k:'ant',   n:'더듬이',      s:'M', d:'긺',     r:'짧음',   뜻:'소리·냄새·떨림을 느끼는 감각기관. 눈이 잘 안 보이는 곳에서 눈 대신 씁니다. 아주 길면 다가오는 재해를 남보다 먼저 알아챕니다.',
      과학:'소리 · 냄새 · 공기의 떨림을 느끼는 감각기관입니다. 눈이 빛에 기대는 것과 달리, 더듬이는 어두워도 씁니다. 아주 길면 멀리서 오는 흔들림까지 잡아내, 재해가 닥치기 전에 알아챕니다.', 유리:'어두운 곳 · 그늘이 짙은 곳 · 물속 · 천적이 있는 곳 · 재해가 잦은 곳', 불리:'모래바람이 부는 곳 (길게 뻗은 것이 쓸립니다)',
      보임:true },
    /* 숨은 형질 4 — 겉으로 드러나지 않는다 */
    { k:'life',  n:'수명',        s:'V', d:'긺',     r:'짧음',   뜻:'한 세대를 더 사는 힘. 오래 살면 교배를 두 번 하지만, 그만큼 몸에 부담이 됩니다.',
      과학:'한 세대를 더 사는 힘입니다. 오래 사는 몸은 손상을 고치는 데 힘을 쓰므로, 그만큼 다른 데 쓸 힘이 줄어 그 세대의 생존은 조금 불리해집니다. 대신 살아남으면 교배를 한 번 더 합니다 — 오래 살기와 잘 살아남기 사이의 주고받기입니다.', 유리:'먹이가 드물어 자손을 자주 못 남기는 곳 (춥거나 메마른 곳)', 불리:'해마다 위험이 큰 곳 — 오래 살 기회 자체가 오지 않습니다',
      보임:false },
    { k:'fec',   n:'번식력',      s:'R', d:'높음',   r:'낮음',   뜻:'한 번 교배할 때 낳는 자손 수. 높을수록 네 마리를 낳을 확률이 올라갑니다.',
      과학:'한 번 교배할 때 낳는 자손 수입니다. 이 형질만은 우열의 법칙을 따르지 않습니다 — 대립유전자가 쌓이는 만큼 확률이 오릅니다. 그래서 잡종도 순종열성보다 낫습니다.', 유리:'자손을 많이 낳으면 그만큼 다양한 유전자가 나옵니다', 불리:'한 마리에 들이는 힘은 줄어듭니다. 자리가 좁으면 서로 붐벼 다 같이 손해입니다',
      보임:false },
    { k:'heat',  n:'내열',        s:'H', d:'강함',   r:'약함',   뜻:'몸속에 쌓이는 열을 견디는 힘. 겉으로는 전혀 드러나지 않습니다.',
      과학:'몸속 단백질이 열에 풀어지지 않게 버티는 힘입니다. 세포 안에서 열을 견디게 돕는 물질을 얼마나 만드느냐로 정해집니다. 겉으로는 전혀 드러나지 않습니다.', 유리:'더운 곳 · 화산처럼 뜨거운 것이 덮치는 때', 불리:'만드는 데 힘이 들어, 서늘한 곳에서는 그 힘이 낭비가 됩니다',
      보임:false },
    { k:'tox',   n:'내독',        s:'X', d:'강함',   r:'약함',   뜻:'독과 나쁜 공기를 견디는 힘. 겉으로는 전혀 드러나지 않습니다.',
      과학:'독과 나쁜 공기를 몸 안에서 풀어 없애는 힘입니다(해독). 간처럼 독을 걸러 내는 기관이 얼마나 잘 도느냐로 정해집니다. 겉으로는 전혀 드러나지 않습니다.', 유리:'쓴 것을 먹어야 하는 곳 · 물속 · 화산재나 먼지가 덮치는 때', 불리:'해독에도 힘이 들어, 깨끗한 곳에서는 그 힘이 낭비가 됩니다',
      보임:false }
  ];
  var NG = GENES.length;
  var 보이는수 = 0;
