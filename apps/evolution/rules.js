...
(function (전역) {
  ...
  var GENES = [
    /* 보이는 형질 9 */
    { k:'fur',   n:'털',          s:'F', d:'두꺼움', r:'얇음',   뜻:'몸을 덮은 털의 두께. 두꺼우면 열이 잘 빠져나가지 않지만, 더운 곳에서는 짐이 되고 물에 젖으면 무거워집니다.', 보임:true },
    { k:'color', n:'색',          s:'D', d:'어두움', r:'밝음',   뜻:'몸 빛깔. 배경과 비슷하면 눈에 덜 띕니다. 어두운 몸은 그늘에, 밝은 몸은 눈밭과 마른 풀에 묻힙니다.', 보임:true },
    { k:'eye',   n:'눈',          s:'E', d:'큰 눈',  r:'작은 눈', 뜻:'눈의 크기. 크면 멀리까지, 어두운 곳까지 봅니다. 대신 강한 빛과 모래바람에 약합니다.', 보임:true },
    { k:'leg',   n:'다리',        s:'L', d:'많음',   r:'적음',   뜻:'다리 수. 많으면 빠르고 잘 넘어지지 않습니다. 대신 무른 땅과 물속에서는 걸리적거립니다.', 보임:true },
    { k:'tall',  n:'키',          s:'T', d:'큼',     r:'작음',   뜻:'몸집과 키. 크면 높은 곳에 닿고 멀리 봅니다. 대신 좁은 곳을 못 지나고 바람과 물살을 그대로 받습니다.', 보임:true },
    { k:'water', n:'물저장 조직', s:'W', d:'있음',   r:'없음',   뜻:'몸 안에 물을 담아 두는 주머니. 있으면 마른 곳에서 버팁니다. 대신 무게가 늘어납니다. — 많다고 늘 좋은 것은 아닙니다.', 보임:true },
    { k:'grip',  n:'발톱',        s:'G', d:'강함',   r:'약함',   뜻:'발끝의 갈고리. 바위와 나뭇가지를 단단히 붙잡습니다.', 보임:true },
    { k:'arm',   n:'팔',          s:'A', d:'있음',   r:'없음',   뜻:'뻗어서 붙잡는 팔. 매달리고 끌어당깁니다. 대신 밖으로 드러난 만큼 열을 잃습니다.', 보임:true },
    { k:'fin',   n:'지느러미',    s:'N', d:'있음',   r:'없음',   뜻:'물을 밀어내는 지느러미. 물에서만 쓸모가 있습니다.', 보임:true },
    /* 더듬이 — 감각기관.
    ...
    { k:'ant',   n:'더듬이',      s:'M', d:'긺',     r:'짧음',   뜻:'소리·냄새·떨림을 느끼는 감각기관. 눈이 잘 안 보이는 곳에서 눈 대신 씁니다. 아주 길면 다가오는 재해를 남보다 먼저 알아챕니다.', 보임:true },
    /* 숨은 형질 4 — 겉으로 드러나지 않는다 */
    { k:'life',  n:'수명',        s:'V', d:'긺',     r:'짧음',   뜻:'한 세대를 더 사는 힘. 오래 살면 교배를 두 번 하지만, 그만큼 몸에 부담이 됩니다.', 보임:false },
    { k:'fec',   n:'번식력',      s:'R', d:'높음',   r:'낮음',   뜻:'한 번 교배할 때 낳는 자손 수. 높을수록 네 마리를 낳을 확률이 올라갑니다.', 보임:false },
    { k:'heat',  n:'내열',        s:'H', d:'강함',   r:'약함',   뜻:'몸속에 쌓이는 열을 견디는 힘. 겉으로는 전혀 드러나지 않습니다.', 보임:false },
    { k:'tox',   n:'내독',        s:'X', d:'강함',   r:'약함',   뜻:'독과 나쁜 공기를 견디는 힘. 겉으로는 전혀 드러나지 않습니다.', 보임:false }
  ];
  var NG = GENES.length;
  var 보이는수 = 0;
